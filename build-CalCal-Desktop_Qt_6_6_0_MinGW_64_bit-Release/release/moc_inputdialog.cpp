...
Q_CONSTINIT static const qt_meta_stringdata_CLASSInputDialogENDCLASS_t qt_meta_stringdata_CLASSInputDialogENDCLASS = {
    {
        ...
        QT_MOC_LITERAL(30, 0),  // ""
        QT_MOC_LITERAL(31, 19)   // "onSaveButtonClicked"
    },
    "InputDialog",
    "saveButtonClicked",
    "",
...
void InputDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &InputDialog::saveButtonClicked; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void InputDialog::saveButtonClicked()
{
